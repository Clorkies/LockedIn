...
interface NewsApiService {
    ...
    fun getEsportsArticles(
        @Query("q") query: String = "(esports OR \"competitive gaming\" OR \"video games\" OR gaming) -football -soccer -basketball -baseball -cricket -rugby -UFC -county -\"track and field\" -\"real madrid\"  -UFC -county -WWE -madrid -united -star -samsung -Madrid -track -FIFA -surf -surfing -NHL -NFL -NBA -MLB -golf -tennis -olympics -sports",
