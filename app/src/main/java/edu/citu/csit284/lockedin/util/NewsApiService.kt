...
interface NewsApiService {
    ...
    fun getEsportsArticles(
        @Query("q") query: String = "(esports OR \"competitive gaming\" OR \"video games\" OR gaming) -football -soccer -basketball -baseball -cricket -rugby -UFC -county -County -(track and field) -(Real madrid) -(real madrid) -(Real Madrid) -NHL -NFL -NBA -MLB -golf -tennis -olympics -sports",
