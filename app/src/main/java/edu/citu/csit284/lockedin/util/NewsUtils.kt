...
fun fetchArticlesSpecific(
    ...
    queryBuilder.append(" -football -soccer -basketball -baseball -cricket -tennis -NFL -NBA -MLB -UFC -county -County -(track and field) -(Real madrid) -(real madrid) -(Real Madrid)")
